...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.clientID, "client-id", "demo-dexclient", "OAuth2 client ID of this application.")
	c.Flags().StringVar(&a.clientSecret, "client-secret", "ZXhhbXBsZS1hcHAtc2VjcmV0", "OAuth2 client secret of this application.")
	c.Flags().StringVar(&a.redirectURI, "redirect-uri", "http://192.168.27.76:8080/callback", "Callback URL for OAuth2 responses.")
	c.Flags().StringVar(&issuerURL, "issuer", "http://172.31.1.10:5556/dex", "URL of the OpenID Connect issuer.")
	c.Flags().StringVar(&listen, "listen", "http://192.168.27.76:8080", "HTTP(S) address to listen at.")
